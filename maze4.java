...
public class snake_maze1 extends Applet implements KeyListener {
    ...
    private void initSnake() {
        ...
        // horizontal right up
        for (int i = 55; i < 60; i++) {
            grid[0][i] = OBSTRUCTION;
        }

        // vertical right up
        for (int i = 0; i < 5; i++) {
            grid[i][59] = OBSTRUCTION;
        }

        // horizontal right down
        for (int i = 55; i < 60; i++) {
            grid[59][i] = OBSTRUCTION;
        }
        ...
        // vertical left down
        for (int i = 55; i < 60; i++) {
            grid[i][0] = OBSTRUCTION;
        }

        // horizontal centre 1
        for (int i = 25; i < 38; i++) {
            grid[25][i] = OBSTRUCTION;
        }

        // horizontal centre 1
        for (int i = 25; i < 38; i++) {
            grid[30][i] = OBSTRUCTION;
            }
